...
<div>
    ...
    <div x-data="{
        ...
        <div class="relative grid w-full grid-cols-2 border-b border-b-neutral-600 pb-2 text-center text-white">
            <p x-bind:class="category === 'questions' ? active : ''" class="relative cursor-pointer" x-on:click="category = 'questions'">Pertanyaan</p>
            <p x-bind:class="category === 'users' ? active : ''" class="relative cursor-pointer" x-on:click="category = 'users'">
                Pengguna</p>
        </div>
