...
<form wire:submit="login">
    ...
    <div class="mt-4 block">
        <label for="remember_me" class="inline-flex items-center">
            <input wire:model="form.remember" id="remember_me" type="checkbox" class="rounde border-gray-700 bg-gray-900 text-green-800 shadow-sm focus:ring-green-800 focus:ring-offset-gray-800" name="remember">
    ...
    <a class="mt-5 block w-max rounded-md text-sm text-gray-200 hover:underline focus:outline-none" href="{{ route('register') }}">
