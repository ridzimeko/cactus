...
new #[Layout('layouts.guest')] #[Title('Registrasi')] class extends Component
{
    public string $name = '';
    public string $email = '';
...
<form wire:submit="register">
    ...
    <div class="mt-4">
        ...
        <x-text-input wire:model="username" id="username" class="mt-1 block w-full" type="text" name="username" required autofocus autocomplete="username" />
    ...
    <a class="mt-4 block w-max rounded-md text-sm text-gray-200 hover:underline focus:outline-none" href="{{ route('login') }}">
